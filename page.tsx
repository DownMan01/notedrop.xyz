...
export default function Home() {
  ...
  const airdrops = [
    // Original 5 airdrops
    {
      id: "1",
      name: "Grass",
      image: "https://www.getgrass.io/_next/image?url=%2Fimages%2Fdashboard.png&w=1920&q=100",
      description: "Grass Network is a decentralized web scraping protocol (DePIN) that enables users to monetize their unused internet bandwidth.",
      chain: "Solana",
      cost: "FREE",
      backers: "Polychain, Hack VC, Tribe Capital, etc.",
      status: "Active",
      stage: "Mainnet",
    },
    {
