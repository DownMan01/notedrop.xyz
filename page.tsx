...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <p>© 2024 NoteDrop. All rights reserved. Developed by <a className="h-4 w-4 text-violet-500" href="https://x.com/jiecrypto0" target="_blank" >jiecrypto0</a> with the help of AI.</p>
    </div>
      </footer>
    </div>
  )
